...
| 文件 | 用途 | 类型 |
|------|------|------|
| [`SKILL.md`](./SKILL.md) | 根级 Skill 定义 v3.1 — prd.json 驱动 + 双模型分工 + Validator | Skill |
| [`decision-agent-prompt.md`](./decision-agent-prompt.md) | 根级子 Agent 操作手册 | Prompt |
...
|------|------|
| 总文件数 | 118 |
| Skill 文件 | 36 (含 9 个技能目录) |
| Hook 脚本 | 10 (7 Python + 1 Shell + 2 系统级) |
| 决策案例 | 25 |
| 决策基础设施 | 9 (Schema/校准器/模型配置/通知策略/权限) |
| 记忆文件 | 8 |
| CodeGraph 文件 | 3 |
| 文档文件 | 7 (README/ARCHITECTURE/SETUP/AGENTS/ALIASES 等) |
| 配置示例 | 3 (phone-notify/scheduled_tasks/settings) |
| 自动化脚本 | 4 (watchdog/termux-listener/route-health-scorer) |

---

*最后更新：2026-06-18 · 引擎版本 v3.0 (Studio 融合 + CodeGraph + 全量合并)*
